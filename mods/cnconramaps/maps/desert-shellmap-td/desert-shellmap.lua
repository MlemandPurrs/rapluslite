...
if DateTime.IsHalloween then
	...
	ProducedUnitTypes =
	{
		...
		{ factory = AlliedWarFactory1, types = { "cnc.jeep", "cnc.maag", "cnc.mtnk", "cnc.mrls", "cnc.mamm" } },
		{ factory = SovietWarFactory1, types = { "cnc.ltnk", "cnc.bggy", "cnc.arty", "cnc.stnk", "cnc.apc.nod" } }
	}
else
	UnitTypes = { "cnc.ltnk", "cnc.stnk", "cnc.ftnk", "cnc.apc.nod" }
...
ShipUnitTypes = { "cnc.apc", "cnc.maag", "cnc.jeep", "cnc.mtnk", "cnc.mtnk" }
...
SendMigs = function(waypoints)
	...
	local migs = Reinforcements.Reinforce(soviets, { "cnc.f22" }, migEntryPath, 4)
