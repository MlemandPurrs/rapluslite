This repository contains the Lite version of RA Plus mod, which is a sub-mod that depends on the Red Alert mod of the [OpenRA](https://github.com/OpenRA/OpenRA) engine.
